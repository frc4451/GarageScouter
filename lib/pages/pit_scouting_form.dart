      ...
      if (kIsWeb) {
        saveFileFromWeb(
          ...
          successMessageSnackbar(
              context, "Successfully saved file to Downloads folder");
        }).catchError((error) {
